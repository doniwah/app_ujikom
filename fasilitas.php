    ...
    <div class="content">
      ...
      <div class="col-md-12">
            ...
            <div class="card card-outline">
              <!-- /.card-header -->
              <div class="card-body">
              <img class="d-block w-100" src="asset/gambar/g3.jpg" height="200">
              </div>
              <!-- /.card-body -->
            </div>
            <!-- /.card -->
          ...
          <div class="col-md-4">
            <div class="card card-outline">
              <!-- /.card-header -->
              <div class="card-body">
              <img class="d-block w-100" src="asset/gambar/g2.jpg" height="200">
              </div>
              <!-- /.card-body -->
            </div>
            <!-- /.card -->
          ...
          <div class="col-md-4">
            <div class="card card-outline">
              <!-- /.card-header -->
              <div class="card-body">
              <img class="d-block w-100" src="asset/gambar/g1.jpg" height="200">
              </div>
              <!-- /.card-body -->
            </div>
            <!-- /.card -->
