                    ...
                    ?>
                      <tr>
                        ...
                        <td>
                          ...
                          <a href="hapus_fasilitas.php?id_fasilitas=<?php echo $d['id_fasilitas']; ?>edit_fasilitas.php?id_fasilitas=<?php echo $d['id_fasilitas']; ?>" class="btn btn btn-danger">Hapus</a>
                        </td>
                      </tr>
                    <?php
                    }
