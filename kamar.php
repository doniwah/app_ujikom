        ...
        <div class="card card-outline card-info">
            <div class="card-body">
                <div class="row">
                    <div class="col-md 4">
                        <div class="card-body card-outline">
                            <table>
                                ...
                                <tr>
                                    <td>
                                        Kasur, Meja Makan,Kamar Mandi, Meja Rias, Full Ac, TV 40"
                                    </td>
                                </tr>
                            </table>
                        </div>
                    ...
                    <div class="col-md-8">
                        <div class="card-body card-outline">
                        <img class="d-block w-100" src="asset/gambar/g2.jpg" height="300">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="card card-outline card-info">
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <div class="card-body card-outline">
                        <img class="d-block w-100" src="asset/gambar/g1.jpg" height="300">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="card card-outline card-info">
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <div class="card-body card-outline">
                        <img class="d-block w-100" src="asset/gambar/g3.jpg" height="300">
                        </div>
                    </div>
                </div>
            </div>
